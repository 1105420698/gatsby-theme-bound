# A simple theme made for HOMEBOUND
...
cd my-site
yarn init
# install gatsby-theme-bound and it's dependencies
yarn add gatsby react react-dom gatsby-theme-bound
```
